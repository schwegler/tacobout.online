...
<div class="wp-block-group has-surface-background-color has-background" style="border-radius:8px;padding-bottom:2rem">
    ...
    <!-- /wp:video -->
    <!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"1rem","right":"2rem","bottom":"1rem","left":"2rem"}}}} -->
    <p style="padding-top:1rem;padding-right:2rem;padding-bottom:1rem;padding-left:2rem">Description of the video.</p>
    <!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
