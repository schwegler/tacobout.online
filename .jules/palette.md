...
## 2024-05-18 - Focus Parity in theme.json
...
**Action:** Always add a mirroring `":focus"` pseudo-class object with identical properties to ensure keyboard users receive corresponding visual feedback.
