...
## 2024-08-11 - Theme.json Focus Parity
**Learning:** In WordPress `theme.json`, defining `:hover` styles does not automatically generate matching `:focus` styles, leaving keyboard navigators without visual feedback.
