...
## 2024-07-26 - Explicit end-of-feed feedback
**Learning:** Infinite scroll features often abruptly stop loading without informing the user. For a good UX, explicitly showing an end-of-feed message is necessary. However, creating the element and hiding it is not enough; it needs to be un-hidden precisely when the data source is exhausted.
